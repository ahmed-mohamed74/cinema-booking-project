...
List <Movie> Drama=[
  Movie(
      ...
      title: "Blueback",
      year: 2022,
      plote: "In a dramatic setting, the work follows Abby's story, in which she and a blue fish develop a strong friendship, but when Abby discovers that her friend is in danger, she embarks on a big adventure to protect her.",
  ...
  Movie(
      ...
      cast: [
        ...
        },
        {
          ...
          "image": "assets/images/GJoseph Gordon-Levitt  discovered by Perrieeele.jpg",
        },
      ]
  ),
...
List<Movie> Horror=[  Movie(
    id: 41,
    title: "fear",
    year: 2023,
    plote: "A much needed getaway and a celebration weekend turns into a nightmare due to the contagious airborne threat.",
  ...
  Movie(
      ...
      title: "M3GAN",
      year: 2022,
      plote: "A robotics engineer at a toy company builds a life-like doll that begins to take on a life of its own.",
  ...
  Movie(
      ...
      title: "Smile",
      year: 2022,
      plote: "After witnessing a bizarre, traumatic incident involving a patient, a psychiatrist becomes increasingly convinced she is being threatened by an uncanny entity.",
...
List<Movie>Comedy=[Movie(
    id: 51,
    title: "Lyle, Lyle, Crocodile",
    year: 2022,
    plote: "Feature film based on the children's book about a crocodile that lives in New York City.",
    poster: "assets/images/Lyle, Lyle, Crocodile.jpg",
    rating: 6.1,
    numOfRating:7700 ,
    genra: [ "Comedy" ,"Animation","adventure"],
    cast: [
      {
  ...
  Movie(
      ...
      year: 2022,
      plote: "An adaptation of the Tony and Olivier award-winning musical. Matilda tells the story of an extraordinary girl who, armed with a sharp mind and a vivid imagination, dares to take a stand to change her story with miraculous results.",
      poster: "assets/images/Matilda the Musical.jpg",
      rating: 7.1,
      numOfRating:19000 ,
      genra: [ "Comedy","Drama" ,"Family"],
      cast: [
        {
  ...
  Movie(
      ...
      title: "Luck",
      year: 2022,
      plote: "The curtain is pulled back on the millennia-old battle between the organizations of good luck and bad luck that secretly affects everyday lives.",
...
List <Movie> comingSoon=[
  Movie(
      ...
      year: 2023,
      plote: "A twisted tale of two estranged sisters whose reunion is cut short by the rise of flesh-possessing demons, thrusting them into a primal battle for survival as they face the most nightmarish version of family imaginable.",
  ...
  Movie(
      ...
      title: "Scream VI",
      year: 2023,
      plote: "In the next installment, the survivors of the Ghostface killings leave Woodsboro behind and start a fresh chapter in New York City.",
